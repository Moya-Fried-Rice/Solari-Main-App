...
// This extension adds connection and disconnection tracking to BluetoothDevice by using streams. It provides isConnecting and isDisconnecting streams and helper methods (connectAndUpdateStream / disconnectAndUpdateStream) so the app can react in real-time when a device is connecting or disconnecting.
